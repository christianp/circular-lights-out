...
var _user$project$Main$classList = function (classes) {
	return _elm_lang$svg$Svg_Attributes$class(
		A2(
			...
			A2(
				_elm_lang$core$List$map,
				_elm_lang$core$Tuple$first,
				A2(_elm_lang$core$List$filter, _elm_lang$core$Tuple$second, classes))));
};
var _user$project$Main$ordinal = function (n) {
...
var _user$project$Main$noCmd = function (x) {
	return {ctor: '_Tuple2', _0: x, _1: _elm_lang$core$Platform_Cmd$none};
};
var _user$project$Main$size = _elm_lang$core$List$length;
var _user$project$Main$circle_diff = F3(
	function (circle, start, i) {
		var n = _user$project$Main$size(circle);
		var d = A2(_elm_lang$core$Basics_ops['%'], (n + i) - start, n);
		return (_elm_lang$core$Native_Utils.cmp(d, (n / 2) | 0) > 0) ? (n - d) : d;
	});
var _user$project$Main$clickable = F2(
	function (game, i) {
		var _p1 = game.selection;
...
var _user$project$Main$Game = F3(
	function (a, b, c) {
		return {circle: a, selection: b, hover: c};
	});
var _user$project$Main$Off = {ctor: 'Off'};
var _user$project$Main$On = {ctor: 'On'};
var _user$project$Main$initCircle = function (n) {
	return {
		ctor: '::',
		_0: _user$project$Main$On,
		_1: A2(_elm_lang$core$List$repeat, n - 1, _user$project$Main$Off)
	};
};
...
var _user$project$Main$toggle_circle = F3(
	function (game, start, d) {
		return _elm_lang$core$Native_Utils.update(
			game,
			{
				circle: A2(
					...
					F2(
						function (i, l) {
							return _elm_lang$core$Native_Utils.eq(
								A2(
									_elm_lang$core$Basics_ops['%'],
									A3(_user$project$Main$circle_diff, game.circle, start, i),
									d),
								0) ? _user$project$Main$toggle(l) : l;
						}),
					game.circle)
			});
	});
var _user$project$Main$ClearHover = {ctor: 'ClearHover'};
var _user$project$Main$SetHover = function (a) {
...
var _user$project$Main$view_circle_segment = F3(
	function (game, i, light) {
		var push = 1;
		var on = _elm_lang$core$Native_Utils.eq(light, _user$project$Main$On);
		var selected = _elm_lang$core$Native_Utils.eq(
			game.selection,
			_user$project$Main$Selected(i));
		var r2 = 5;
		var r1 = 10;
		var fi = _elm_lang$core$Basics$toFloat(i);
		var n = _user$project$Main$size(game.circle);
		var fn = _elm_lang$core$Basics$toFloat(n);
		var gap = fn * 30;
		var an1 = ((2 * _elm_lang$core$Basics$pi) * ((fi - 0.5) + (fn / gap))) / fn;
		var x1 = r1 * _elm_lang$core$Basics$cos(an1);
		var y1 = r1 * _elm_lang$core$Basics$sin(an1);
		var x3 = r2 * _elm_lang$core$Basics$cos(an1);
		var y3 = r2 * _elm_lang$core$Basics$sin(an1);
		var an2 = ((2 * _elm_lang$core$Basics$pi) * ((fi + 0.5) - (fn / gap))) / fn;
		var x2 = r1 * _elm_lang$core$Basics$cos(an2);
		var y2 = r1 * _elm_lang$core$Basics$sin(an2);
		var x4 = r2 * _elm_lang$core$Basics$cos(an2);
		var y4 = r2 * _elm_lang$core$Basics$sin(an2);
		var outline = A3(
			_folkertdev$svg_path_dsl$Svg_Path$subpath,
			_folkertdev$svg_path_dsl$Svg_Path$startAt(
				{ctor: '_Tuple2', _0: x3, _1: y3}),
			_folkertdev$svg_path_dsl$Svg_Path$closed,
			{
				...
				_1: {
					...
					_0: A4(
						...
						{ctor: '_Tuple2', _0: r1, _1: r1},
						0,
						{ctor: '_Tuple2', _0: _folkertdev$svg_path_dsl$Svg_Path$smallestArc, _1: _folkertdev$svg_path_dsl$Svg_Path$clockwise},
					...
					_1: {
						...
						_1: {
							...
							_0: A4(
								_folkertdev$svg_path_dsl$Svg_Path$arcTo,
								{ctor: '_Tuple2', _0: r2, _1: r2},
								0,
								{ctor: '_Tuple2', _0: _folkertdev$svg_path_dsl$Svg_Path$smallestArc, _1: _folkertdev$svg_path_dsl$Svg_Path$antiClockwise},
								{ctor: '_Tuple2', _0: x3, _1: y3}),
							_1: {ctor: '[]'}
						}
					}
		...
		var angle = ((2 * _elm_lang$core$Basics$pi) * _elm_lang$core$Basics$toFloat(i)) / _elm_lang$core$Basics$toFloat(n);
		return A2(
			_elm_lang$svg$Svg$g,
			{
				ctor: '::',
				_0: _user$project$Main$classList(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'light', _1: true},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'selected', _1: selected},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'on', _1: on},
								_1: {
									ctor: '::',
									_0: {
										ctor: '_Tuple2',
				...
				_1: {
					...
					_0: _elm_lang$svg$Svg_Events$onClick(
						_user$project$Main$Click(i)),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Events$onMouseOver(
							_user$project$Main$SetHover(i)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Events$onMouseOut(_user$project$Main$ClearHover),
							_1: {ctor: '[]'}
						}
					}
				}
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _folkertdev$svg_path_dsl$Svg_Path$pathToAttribute(
							{
								ctor: '::',
								_0: outline,
								_1: {ctor: '[]'}
...
var _user$project$Main$view = function (game) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$stylesheet(_user$project$Main$css),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Number of lights: '),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$max('500'),
													_1: {
														ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$viewBox('-12 -12 24 24'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$class('circle'),
									_1: {ctor: '[]'}
								},
								A2(
									_elm_lang$core$List$indexedMap,
									_user$project$Main$view_circle_segment(game),
									game.circle)),
							_1: {ctor: '[]'}
						}),
					_1: {
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: _elm_lang$html$Html$text(
											_user$project$Main$hover_description(game)),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
...
var _user$project$Main$NoSelection = {ctor: 'NoSelection'};
var _user$project$Main$initGame = {
	circle: _user$project$Main$initCircle(12),
